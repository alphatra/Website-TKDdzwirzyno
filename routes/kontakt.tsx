...
export default define.page(function Kontakt(props) {
  ...
  return (
    <>
      <Head>
        <title>Kontakt - TKD Dzwirzyno</title>
      </Head>

      <Header menuPages={menuPages} />

      <main class="min-h-screen bg-white dark:bg-background-dark text-slate-900 dark:text-slate-100">
        {/* Helper Gradient */}
        ...
        <section class="relative pt-32 pb-20 px-4 z-10">
          <div class="container-custom text-center">
            ...
            <h1 class="font-display text-5xl md:text-7xl font-black uppercase tracking-tighter mb-6 animate-slide-up animation-delay-100">
              Trenuj z <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Nami</span>
            </h1>
            <p class="text-xl text-slate-500 dark:text-slate-400 max-w-2xl mx-auto font-light animate-slide-up animation-delay-200">
              Zapraszamy na treningi do naszej sali w Gminnym Ośrodku Sportu i Rekreacji.
            </p>
          </div>
        </section>
            ...
            <div class="grid lg:grid-cols-2 gap-12 xl:gap-20 items-stretch">
              ...
              <div class="bg-slate-50 dark:bg-slate-900/50 backdrop-blur-sm border border-slate-100 dark:border-slate-800 rounded-3xl p-8 md:p-12 flex flex-col justify-center space-y-12 shadow-xl">
                ...
                <div class="flex items-start gap-6 group">
                  ...
                  <div>
                    <h3 class="font-heading text-xl font-bold mb-2 text-slate-900 dark:text-white">Adres</h3>
                    <p class="text-slate-600 dark:text-slate-400 leading-relaxed">
                      Gminne Centrum Sportu i Turystyki<br />
                      ul. Wyzwolenia 28<br />
                      78-131 Dźwirzyno
                    </p>
                  </div>
                ...
                <div class="flex items-start gap-6 group">
                  ...
                  <div>
                    <h3 class="font-heading text-xl font-bold mb-2 text-slate-900 dark:text-white">Telefon</h3>
                    <p class="text-slate-600 dark:text-slate-400 mb-2">
                      Trener Główny
                    </p>
                    <a href="tel:+48123456789" class="text-xl font-bold hover:text-primary transition-colors">
                      +48 123 456 789
                    </a>
                  </div>
                </div>
                ...
                <div class="flex items-start gap-6 group">
                  ...
                  <div>
                    <h3 class="font-heading text-xl font-bold mb-2 text-slate-900 dark:text-white">Email</h3>
                    <a href="mailto:kontakt@tkddzwirzyno.pl" class="text-lg hover:text-primary transition-colors">
                      kontakt@tkddzwirzyno.pl
                    </a>
                  </div>
                </div>
